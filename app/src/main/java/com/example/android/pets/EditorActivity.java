...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void savePet(){
        ...
        if (uri == null &&
                ...
                TextUtils.isEmpty(String.valueOf(weight)) && mGender == PetContract.PetEntry.GENDER_UNKNOWN) {return;}

        // If the weight is not provided by the user, don't try to parse the string into an
        // integer value. Use 0 by default.
        int weightt = 0;
        if (!TextUtils.isEmpty(weight)) {
            weightt = Integer.parseInt(weight);
        }
        values.put(PetContract.PetEntry. COLUMN_PET_WEIGHT, weightt);
        ...
        Uri newUri = null;
        int newUpdate = 0;
        if(getTitle().equals(getString(R.string.editor_activity_title_new_pet))) {
